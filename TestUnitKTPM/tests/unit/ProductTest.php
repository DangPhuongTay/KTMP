...
class ProductTest extends TestCase
{
  protected $Product;
    ...
    {
        $this->Product->setInfoProduct('Iphone 14 Pro Max','Chiếc iPhone 14 Pro Max VN/A sở hữu màn hình Super Retina XDR mới với ProMotion có kích thước 6.7 inch. Tần số quét màn hình sẽ giảm xuống 1 Hz để tiết kiệm pin, trong khi hình nền được làm mờ. Màn hình tiên tiến cũng mang lại mức độ sáng HDR cao nhất tương tự như Pro Display XDR và ​​độ sáng đỉnh ngoài trời cao nhất trong điện thoại thông minh: lên đến 2000 nits, sáng gấp đôi so với người tiền nhiệm.','290000','iphone-14-pro-max-1.webp','<iphone-14-pro-max-2></iphone-14-pro-max-2>.webp',"iphone-14-pro-max-3.webp");
        $this->assertEquals($this->Product ->getInfoProduct(),['Iphone 14 Pro Max','Chiếc iPhone 14 Pro Max VN/A sở hữu màn hình Super Retina XDR mới với ProMotion có kích thước 6.7 inch. Tần số quét màn hình sẽ giảm xuống 1 Hz để tiết kiệm pin, trong khi hình nền được làm mờ. Màn hình tiên tiến cũng mang lại mức độ sáng HDR cao nhất tương tự như Pro Display XDR và ​​độ sáng đỉnh ngoài trời cao nhất trong điện thoại thông minh: lên đến 2000 nits, sáng gấp đôi so với người tiền nhiệm.','290000','iphone-14-pro-max-1.webp','<iphone-14-pro-max-2></iphone-14-pro-max-2>.webp',"iphone-14-pro-max-3.webp"]);
